...
- **Phase 4** — ✅ 完了 2026-06-18: `help` 全画面ヘルプ、5 種テーマ (`theme <name>`)、設定ファイル `/sd/psephos_config.txt` で永続化
- **Phase 5**（候補）: グラフ描画 (`plot(expr, xmin, xmax)`、`compile()` で 12〜16 倍高速化済の検証あり)、履歴ローテーション
